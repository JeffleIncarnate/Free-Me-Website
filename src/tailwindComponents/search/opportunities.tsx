...
/* 
    This is for consultants to search for clients
*/
const SearchClient = () => {
  const industries = [
    "Manufacturing",
                ...
                {industries.map((industry) => (
                  ...
                  >
                    <input
                      id="default-checkbox"
                      type="checkbox"
                      checked={selectedSkills.includes(industry)}
