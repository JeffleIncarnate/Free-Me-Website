...
export default function SocialMediaLeft() {
  ...
  let companies: IRecentlyVisitedCompany[] = [
    {
      img: "https://i.pinimg.com/474x/b0/d2/6e/b0d26e8122dffa8a51081f7f814581d7.jpg",
      name: "Apple",
    },
    {
  ...
  return (
    <div className="FRE__Main__Left">
      ...
      <SocialMediaLeftBottom companies={companies} />
    </div>
  );
}
...
function SocialMediaLeftBottom({
  companies,
}: {
  [key: string]: IRecentlyVisitedCompany[];
}) {
  return (
    <div className="FRE__Main__Left__Bottom">
      <h2>Recently visited company’s</h2>

      {companies.map((comapny: IRecentlyVisitedCompany) => {
        return (
          <SocialMediaLeftBottomCompany img={comapny.img} name={comapny.name} />
        );
      })}
    </div>
  );
...
function SocialMediaLeftBottomCompany({ img, name }: IRecentlyVisitedCompany) {
  return (
    <div className="FRE__Main__Left__Bottom__Company">
      <img src={img} alt="Comapny Img" />
