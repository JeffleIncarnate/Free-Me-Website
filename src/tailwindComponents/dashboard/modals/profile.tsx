...
export default function ProfileModal() {
  ...
  return (
    <>
      <main className="w-full h-full overflow-y-scroll flex items-center justify-center flex-col">
        <div
          className="h-[40rem] w-full flex items-end justify-between bg-no-repeat bg-cover bg-center border-3 border-white rounded-xl"
          style={{ backgroundImage: `url("${background}")` }}
        >
          <img
            className="bg-neutral-900 h-[14rem] border-3 border-white rounded-full p-4 m-4 relative top-28 left-8 aspect-square"
          ...
          <div>
            <button className="m-4 py-2 px-8 border-3 border-white rounded-sm bg-neutral-900 text-xl">
              Add Background
            </button>
            <button className="m-4 py-2 px-8 border-3 border-white rounded-sm bg-neutral-900 text-xl">
              Upload Photo
